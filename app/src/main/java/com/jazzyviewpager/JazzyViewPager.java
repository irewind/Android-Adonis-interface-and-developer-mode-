...
public class JazzyViewPager extends ViewPager {
	...
	private HashMap<Integer, Fragment> mObjs = new LinkedHashMap<Integer, Fragment>();
...
//                ViewHelper.setScaleY(left, mScale);
				ViewHelper.setPivotX(left, left.getMeasuredWidth()/10);
				ViewHelper.setPivotY(left, left.getMeasuredHeight()/2);
				ViewHelper.setScaleX(left, mScale);
				ViewHelper.setScaleY(left, mScale);
			}
...
//				ViewHelper.setPivotX(right, right.getMeasuredWidth()*0.8f);
//				ViewHelper.setPivotY(right, right.getMeasuredHeight()*0.8f);
...
//		mRight = getChildAt(position+1);
	...
	public void setObjectForPosition(Fragment obj, int position) {
