...
public class IRAccountPersonalActivity extends IRBaseActivity{

    private ImageButton abBack, abSearch;
    private TextView abTitle;
    private Button abAction;
    private IRAccountPersonalFragment mFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            mFragment = IRAccountPersonalFragment.newInstance();
    ...
    protected void onResume() {
        ...
        abTitle.setText(getString(R.string.personal_data));
