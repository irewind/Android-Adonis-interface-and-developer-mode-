...
public class IRAccountNotificationActivity extends IRBaseActivity{
    private ImageButton abBack, abSearch;
    private TextView abTitle;
    private Button abAction;
    private IRAccountNotificationFragment mFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            mFragment = IRAccountNotificationFragment.newInstance();
    ...
    protected void onResume() {
        ...
        abTitle.setText(getString(R.string.notif_email));
