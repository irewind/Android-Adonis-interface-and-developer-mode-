 ...
 */
package com.irewind.utils.exoplayer.player;
 ...
 * with one of a number of  classes to suit different use cases (e.g. DASH,
...
public class DemoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  /**
   * A callback invoked by a .
   */
  public interface RendererBuilderCallback {
    /**
     * Invoked with the results from a .
     *
     * @param trackNames The names of the available tracks, indexed by  TYPE_*
     ...
     *     indexed by  TYPE_* constants. May be null if there are no types with
