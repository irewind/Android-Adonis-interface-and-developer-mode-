 ...
 * </p>
 */
public class SharedPreferencesCache extends TokenCachingStrategy {

    private static final String DEFAULT_CACHE_KEY = "com.irewind.SharedPreferencesCache.DEFAULT_KEY";
     ...
     * @throws NullPointerException if the passed in Context is null
     */
    public SharedPreferencesCache(Context context, String cacheKey) {
        if (context == null) {
            return;
        }
        this.cacheKey = (cacheKey != null && cacheKey.length() > 0) ? DEFAULT_CACHE_KEY : cacheKey;
    ...
    public Bundle load() {
        ...
        for (String key : allCachedEntries.keySet()) {
            try {
                ...
                Log.d(TAG, "Error reading cached value for key: '" + key + "' -- " + e);
                return null;
            }
        }
    ...
    public void save(Bundle bundle) {
        ...
        for (String key : bundle.keySet()) {
            try {
                ...
                Log.d(TAG, "Error processing value for key: '" + key + "' -- " + e);
